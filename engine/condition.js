...
// All game conditions (weather, time, HP, faction, reputation, map, etc.)
// are evaluated through a single system
...
var ConditionSystem = {
    ...
    evaluate: function(condition, context) {
        ...
        if (operator === 'and') {
            return conditions.every(function(c) { return ConditionSystem._evalSingle(c, context); });
        } else if (operator === 'or') {
            return conditions.some(function(c) { return ConditionSystem._evalSingle(c, context); });
        } else if (operator === 'not') {
            return !ConditionSystem._evalSingle(conditions[0], context);
        }
    ...
    _getValue: function(type, target, context) {
        switch (type) {
            case 'stat':
                return player ? (player[target] || 0) : 0;
            case 'item':
                return typeof countItemInInventory !== 'undefined' ? countItemInInventory(target) : 0;
            case 'building':
                return typeof hasBuilding !== 'undefined' && hasBuilding(target) ? 1 : 0;
            case 'level':
                return player ? (player.level || 1) : 1;
            case 'map':
                return typeof mapSystem !== 'undefined' && mapSystem.currentMap === target ? 1 : 0;
            case 'weather':
                return typeof weatherSystem !== 'undefined' && weatherSystem.currentWeather === target ? 1 : 0;
            case 'season':
                return player && player.gameTime ? (player.gameTime.season === target ? 1 : 0) : 0;
            case 'hour':
                return player && player.gameTime ? player.gameTime.hour : 0;
            case 'day':
                return player && player.gameTime ? player.gameTime.day : 0;
            case 'faction':
                return player && player.faction === target ? 1 : 0;
            case 'worldState':
                return typeof WorldState !== 'undefined' ? (WorldState.state[target] || 0) : 0;
            case 'npcRelation':
                return typeof WorldState !== 'undefined' ? WorldState.getNPCRelation(target) : 0;
            case 'factionRep':
                return typeof WorldState !== 'undefined' ? WorldState.getFactionRep(target) : 0;
            case 'bossKilled':
                return typeof WorldState !== 'undefined' && WorldState.isBossKilled(target) ? 1 : 0;
            case 'buff':
                return typeof BuffSystem !== 'undefined' && BuffSystem.has('player', target) ? 1 : 0;
            case 'questCompleted':
                return typeof questSystem !== 'undefined' && questSystem.completedQuests.includes(target) ? 1 : 0;
            case 'constant':
                return target;
            default:
                return 0;
    ...
    // Helper: create condition objects
